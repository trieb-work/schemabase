...
/* harmony import */ var _eci_util_errors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(928);
...
const webhook = async ({
  ...
  if (!webhook) {
    throw new _eci_util_errors__WEBPACK_IMPORTED_MODULE_2__/* .HttpError */ .oo(404, `Webhook not found: ${webhookId}`);
  }
...
var __webpack_exports__ = __webpack_require__.X(0, [881,906], function() { return __webpack_exec__(461); });
