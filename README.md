...
This is an official pnpm v1 starter turborepo.

## What's inside?

This turborepo uses [pnpm](https://classic.pnpmpkg.com/lang/en/) as a package
...
choosing which package manager you wish to use with your monorepo (pnpm).
