...
export type GetWarehousesQuery = { __typename?: "Query" } & {
  warehouses?: Maybe<
    { __typename?: "WarehouseCountableConnection" } & {
      edges: Array<
        { __typename?: "WarehouseCountableEdge" } & {
          node: { __typename?: "Warehouse" } & Pick<Warehouse, "id" | "name" | "slug">
        }
      >
    }
  >
...
export type VerifyAppTokenMutationVariables = Exact<{
  token: Scalars["String"]
}>

export type VerifyAppTokenMutation = { __typename?: "Mutation" } & {
  appTokenVerify?: Maybe<{ __typename?: "AppTokenVerify" } & Pick<AppTokenVerify, "valid">>
}
...
export type GetOrderQuery = { __typename?: "Query" } & {
  order?: Maybe<
    { __typename?: "Order" } & Pick<Order, "status" | "token" | "id" | "paymentStatus"> & {
        shippingPrice: { __typename?: "TaxedMoney" } & Pick<TaxedMoney, "currency"> & {
            gross: { __typename?: "Money" } & Pick<Money, "amount">
            net: { __typename?: "Money" } & Pick<Money, "amount">
          }
        total: { __typename?: "TaxedMoney" } & Pick<TaxedMoney, "currency"> & {
            gross: { __typename?: "Money" } & Pick<Money, "amount">
          }
        fulfillments: Array<
          Maybe<
            { __typename?: "Fulfillment" } & Pick<Fulfillment, "created" | "trackingNumber"> & {
                lines?: Maybe<
                  Array<
                    Maybe<
                      { __typename?: "FulfillmentLine" } & Pick<
                        FulfillmentLine,
                        "id" | "quantity"
                      > & {
                          orderLine?: Maybe<
                            { __typename?: "OrderLine" } & Pick<OrderLine, "productSku">
                          >
                        }
                    >
                  >
        ...
        voucher?: Maybe<
          { __typename?: "Voucher" } & Pick<
            Voucher,
            "id" | "code" | "discountValue" | "type" | "discountValueType"
          >
        >
        privateMetadata: Array<
          Maybe<{ __typename?: "MetadataItem" } & Pick<MetadataItem, "key" | "value">>
        >
        lines: Array<
          Maybe<
            { __typename?: "OrderLine" } & Pick<
              OrderLine,
              "id" | "quantity" | "productSku" | "taxRate"
            > & {
                unitPrice: { __typename?: "TaxedMoney" } & {
                  gross: { __typename?: "Money" } & Pick<Money, "currency" | "amount">
                }
                variant?: Maybe<
...
export type CreateFulfillmentMutation = { __typename?: "Mutation" } & {
  orderFulfill?: Maybe<
    { __typename?: "OrderFulfill" } & {
      fulfillments?: Maybe<
        Array<Maybe<{ __typename?: "Fulfillment" } & Pick<Fulfillment, "id" | "status">>>
      >
      orderErrors: Array<
        { __typename?: "OrderError" } & Pick<OrderError, "field" | "message" | "code">
      >
    }
  >
}
...
export type SetTrackingNumberMutation = { __typename?: "Mutation" } & {
  orderFulfillmentUpdateTracking?: Maybe<
    { __typename?: "FulfillmentUpdateTracking" } & {
      fulfillment?: Maybe<
        { __typename?: "Fulfillment" } & Pick<Fulfillment, "id" | "trackingNumber">
      >
      orderErrors: Array<
        { __typename?: "OrderError" } & Pick<OrderError, "field" | "message" | "code">
      >
...
export type GetVariantQuery = { __typename?: "Query" } & {
  productVariant?: Maybe<
    { __typename?: "ProductVariant" } & Pick<ProductVariant, "id" | "name"> & {
        images?: Maybe<
          Array<Maybe<{ __typename?: "ProductImage" } & Pick<ProductImage, "url" | "id">>>
        >
        stocks?: Maybe<
          Array<
            Maybe<
              { __typename?: "Stock" } & Pick<Stock, "quantityAllocated"> & {
                  warehouse: { __typename?: "Warehouse" } & Pick<Warehouse, "id" | "name">
                }
            >
          >
        >
...
export type GetProductQueryQuery = { __typename?: "Query" } & {
  product?: Maybe<
    { __typename?: "Product" } & Pick<Product, "name" | "slug" | "updatedAt"> & {
        images?: Maybe<
          Array<Maybe<{ __typename?: "ProductImage" } & Pick<ProductImage, "id" | "url">>>
        >
        productType: { __typename?: "ProductType" } & Pick<ProductType, "hasVariants">
        variants?: Maybe<
          Array<
            Maybe<
...
export type UpdateStockLevelMutationVariables = Exact<{
  variantId: Scalars["ID"]
  warehouseId: Scalars["ID"]
  quantity: Scalars["Int"]
}>

export type UpdateStockLevelMutation = { __typename?: "Mutation" } & {
  productVariantStocksUpdate?: Maybe<
    { __typename?: "ProductVariantStocksUpdate" } & {
      productVariant?: Maybe<
        { __typename?: "ProductVariant" } & Pick<ProductVariant, "id" | "name">
      >
      bulkStockErrors: Array<
        { __typename?: "BulkStockError" } & Pick<BulkStockError, "field" | "message" | "code">
      >
    }
  >
}
...
export type GetShopDomainQuery = { __typename?: "Query" } & {
  shop: { __typename?: "Shop" } & DomainFragmentFragment
}

export type AddPrivateMetaMutationVariables = Exact<{
  id: Scalars["ID"]
  input: Array<MetadataInput> | MetadataInput
}>

export type AddPrivateMetaMutation = { __typename?: "Mutation" } & {
  updatePrivateMetadata?: Maybe<
    { __typename?: "UpdatePrivateMetadata" } & {
      item?: Maybe<
        | ({ __typename?: "App" } & {
            privateMetadata: Array<
      ...
      metadataErrors: Array<
        { __typename?: "MetadataError" } & Pick<MetadataError, "field" | "message" | "code">
      >
    }
  >
}
...
export type OrderCaptureMutation = { __typename?: "Mutation" } & {
  orderCapture?: Maybe<
    { __typename?: "OrderCapture" } & {
      errors: Array<{ __typename?: "OrderError" } & OrderErrorFragmentFragment>
      order?: Maybe<{ __typename?: "Order" } & OrderDetailsFragmentFragment>
    }
  >
}
...
export type ChannelsQuery = { __typename?: "Query" } & {
  channels?: Maybe<Array<{ __typename?: "Channel" } & ChannelsFragmentFragment>>
}

export type ProductDataFeedQueryVariables = Exact<{
  first: Scalars["Int"]
  channel?: Maybe<Scalars["String"]>
}>

export type ProductDataFeedQuery = { __typename?: "Query" } & {
  products?: Maybe<
    { __typename?: "ProductCountableConnection" } & {
      edges: Array<
        { __typename?: "ProductCountableEdge" } & {
          node: { __typename?: "Product" } & Pick<
            ...
            | "slug"
          > & {
              weight?: Maybe<{ __typename?: "Weight" } & Pick<Weight, "unit" | "value">>
              images?: Maybe<
                Array<Maybe<{ __typename?: "ProductImage" } & Pick<ProductImage, "id" | "url">>>
              >
              metadata: Array<
              ...
              attributes: Array<
                { __typename?: "SelectedAttribute" } & {
                  ...
                  values: Array<
                    Maybe<{ __typename?: "AttributeValue" } & Pick<AttributeValue, "id" | "name">>
                  >
                }
              >
              productType: { __typename?: "ProductType" } & Pick<
                ProductType,
                "name" | "id" | "hasVariants"
              >
              variants?: Maybe<
                Array<
                  Maybe<
                    ...
                    > & {
                        ...
                        metadata: Array<
                          Maybe<
                            { __typename?: "MetadataItem" } & Pick<MetadataItem, "key" | "value">
                          >
                        >
                        pricing?: Maybe<
                          { __typename?: "VariantPricingInfo" } & Pick<
                            VariantPricingInfo,
                            "onSale"
                          > & {
                              priceUndiscounted?: Maybe<
                                { __typename?: "TaxedMoney" } & {
                                  gross: { __typename?: "Money" } & Pick<
                                    Money,
                                    "amount" | "currency"
                                  >
                                }
                        ...
                        >
                        images?: Maybe<
                          Array<Maybe<{ __typename?: "ProductImage" } & Pick<ProductImage, "url">>>
                        >
                      }
                  >
                >
...
export type GetPaymentQuery = { __typename?: "Query" } & {
  payment?: Maybe<
    { __typename?: "Payment" } & {
      transactions?: Maybe<
        Array<Maybe<{ __typename?: "Transaction" } & Pick<Transaction, "id" | "token">>>
      >
    }
  >
}
