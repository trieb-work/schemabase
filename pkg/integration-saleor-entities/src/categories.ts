...
import { SaleorCronCategoriesQuery, queryWithPagination } from "@eci/pkg/saleor";
...
export class SaleorCategorySyncService {
    ...
    public async syncToEci() {
        ...
        this.logger.info(`Comparing saleor categories: (Delete: ${categoriesToDelete} / Compare: ${categoriesToUpdate} / Create: ${categoriesToCreate})`)
        await Promise.all([
