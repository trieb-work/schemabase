...
export class XentralProxyProductVariantSyncService {
    ...
    public async syncFromECI(): Promise<void> {
        ...
        this.logger.info(
            ...
            {
                creatingProductVariantSKUs: missingProductVariants.map(
                    (x) => x.sku,
                ),
            },
        );
        ...
        for (const productVariant of productVariants) {
            ...
            if (existingXentralArtikel) {
                ...
                if (
                    ...
                    (existingXentralArtikel.ean || null) ===
                        (artikel.ean || null) &&
                    ...
                    (existingXentralArtikel.typ || null) ===
                        (artikel.typ || null)
                ) {
                    this.logger.debug(
                ...
                this.logger.info(
                    "Editing Artikel in Xentral-Stammdaten",
                    loggerFields,
                );
                ...
                this.logger.info(
                    `Created new xentralArtikel for current productVariant`,
                    {
                        ...
                        xentralArtikelNummer:
                            createdXentralArtikel.xentralNummer,
                    },
                );
            }
        }
