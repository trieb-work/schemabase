        ...
        for (const orderWithoutZohoInvoice of ordersWithoutZohoInvoicesFromEciDb) {
            try {
                ...
                const zohoSalesOrder =
                    orderWithoutZohoInvoice.zohoSalesOrders[0];
                const createdInvoice =
                    await this.zoho.invoice.createFromSalesOrder(
                        zohoSalesOrder.id,
                    );
                ...
                const zohoInvoiceConnectOrCreate: Prisma.Enumerable<Prisma.ZohoInvoiceCreateOrConnectWithoutInvoiceInput> =
                    {
                        ...
                        create: {
                            ...
                            updatedAt: new Date(
                                createdInvoice.last_modified_time,
                            ),
                ...
                this.logger.info(
                    `Successfully created a zoho Invoice ${createdInvoice.invoice_number}`,
                    {
                        ...
                        orderMainContactId:
                            orderWithoutZohoInvoice.mainContactId,
                    ...
                    if ((err as ZohoApiError).code === 36026) {
                        this.logger.warn(
                                ...
                                err.message,
                            {
                                eciOrderId: orderWithoutZohoInvoice.id,
                                eciOrderNumber:
                                    orderWithoutZohoInvoice.orderNumber,
                            },
                        );
                    } else {
