...
export type Channel = Node & {
    ...
    availableShippingMethodsPerCountry?: Maybe<
        Array<ShippingMethodsPerCountry>
    >;
    /**
...
export type ProductVariantBulkCreateMutationVariables = Exact<{
    variants:
        | Array<ProductVariantBulkCreateInput>
...
export type SaleorCronPackagesOverviewQueryVariables = Exact<{
    ...
    after?: InputMaybe<Scalars["String"]>;
    first?: InputMaybe<Scalars["Int"]>;
    orderStatusFilter?: InputMaybe<
        Array<OrderStatusFilter> | OrderStatusFilter
    >;
...
export function getSdk<C, E>(requester: Requester<C, E>) {
    return {
        ...
        productVariantBulkCreate(
            ...
            >(
                ProductVariantBulkCreateDocument,
                variables,
                options,
