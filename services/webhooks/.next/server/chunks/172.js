...
exports.modules = {
  ...
  /***/ 69523: /***/ (
    ...
    class EnvironmentVariableNotFoundError
      /* unused pure expression or super */ extends (null && GenericError)
    {
      /**
  ...
  /***/ 65400: /***/ (
    ...
    var ecs_winston_format_default =
      /*#__PURE__*/ __webpack_require__.n(ecs_winston_format); // CONCATENATED MODULE: ../../pkg/logger/src/logger.ts
    class Logger {
      constructor(config) {
        this.logDrains = [];
        this.meta = {
          env: mod /* env.require */.O.require("ECI_ENV"),
          commit: mod /* env.get */.O.get(
            "GIT_COMMIT_SHA",
            mod /* env.get */.O.get("VERCEL_GIT_COMMIT_SHA"),
          ),
          ...(config === null || config === void 0 ? void 0 : config.meta),
        };
        this.logger = winston_default().createLogger({
          transports: [new (winston_default().transports.Console)()],
        ...
        if (this.meta["env"] === "production") {
           ...
           */ this.elasticSearchTransport =
            new winston_elasticsearch.ElasticsearchTransport({
              level: "info",
              dataStream: true,
              clientOpts: {
                node: mod /* env.require */.O.require("ELASTIC_LOGGING_SERVER"),
                auth: {
                  username: mod /* env.require */.O.require(
                    "ELASTIC_LOGGING_USERNAME",
                  ),
                  password: mod /* env.require */.O.require(
      ...
      async flush() {
        var ref;
        await Promise.all([
          (ref = this.elasticSearchTransport) === null || ref === void 0
            ? void 0
            : ref.flush(),
        ]);
      }
    ...
    var headers = __webpack_require__(65166); // CONCATENATED MODULE: ../../pkg/http/src/eciApiHandler.ts
    /**
     ...
     */ function handleWebhook({ webhook, validation }) {
      return async (req, res) => {
         ...
         */ const traceId =
          req.headers[headers /* ECI_TRACE_HEADER */.X] ?? ids.id.id("trace");
        ...
        try {
          ...
          res.status(
            err instanceof errors /* HttpError */.oo ? err.statusCode : 500,
          );
          res.json({
    ...
    var node_modules_axios = __webpack_require__(5559); // CONCATENATED MODULE: ../../pkg/http/src/http.ts
  ...
  /***/ 26240: /***/ (
    ...
    var src = __webpack_require__(38340); // CONCATENATED MODULE: ../../pkg/ids/src/id.ts
    const prefixes = {
      message: "m",
      trace: "tr",
      secretKey: "sk",
    ...
    const id = new src.IdGenerator(prefixes); // CONCATENATED MODULE: ../../pkg/ids/index.ts
