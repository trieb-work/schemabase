...
exports.modules = {
  /***/ 50077: /***/ (
    ...
    var main_default = /*#__PURE__*/ __webpack_require__.n(main); // CONCATENATED MODULE: ../../pkg/saleor/src/api/generated/graphql.ts
    ...
    (function (AttributeSortField) {
      ...
      AttributeSortField["StorefrontSearchPosition"] =
    ...
    (function (ChannelErrorCode) {
      ...
      ChannelErrorCode["ChannelsCurrencyMustBeTheSame"] =
    ...
    (function (CheckoutErrorCode) {
      ...
      CheckoutErrorCode["ProductUnavailableForPurchase"] =
        "PRODUCT_UNAVAILABLE_FOR_PURCHASE";
      CheckoutErrorCode["QuantityGreaterThanLimit"] =
        "QUANTITY_GREATER_THAN_LIMIT";
      CheckoutErrorCode["Required"] = "REQUIRED";
      CheckoutErrorCode["ShippingAddressNotSet"] = "SHIPPING_ADDRESS_NOT_SET";
      CheckoutErrorCode["ShippingMethodNotApplicable"] =
      ...
      CheckoutErrorCode["UnavailableVariantInChannel"] =
    ...
    (function (DiscountErrorCode) {
      ...
      DiscountErrorCode["CannotManageProductWithoutVariant"] =
        "CANNOT_MANAGE_PRODUCT_WITHOUT_VARIANT";
    ...
    (function (OrderErrorCode) {
      ...
      OrderErrorCode["ProductUnavailableForPurchase"] =
        "PRODUCT_UNAVAILABLE_FOR_PURCHASE";
      OrderErrorCode["Required"] = "REQUIRED";
      OrderErrorCode["ShippingMethodNotApplicable"] =
        "SHIPPING_METHOD_NOT_APPLICABLE";
    ...
    (function (OrderEventsEmailsEnum) {
      ...
      OrderEventsEmailsEnum["FulfillmentConfirmation"] =
    ...
    (function (OrderEventsEnum) {
      ...
      OrderEventsEnum["OrderLineDiscountRemoved"] =
        "ORDER_LINE_DISCOUNT_REMOVED";
      OrderEventsEnum["OrderLineDiscountUpdated"] =
    ...
    (function (PaymentErrorCode) {
      ...
      PaymentErrorCode["PartialPaymentNotAllowed"] =
    ...
    (function (PermissionEnum) {
      ...
      PermissionEnum["ManagePageTypesAndAttributes"] =
    ...
    (function (PermissionGroupErrorCode) {
      ...
      PermissionGroupErrorCode["CannotRemoveFromLastGroup"] =
        "CANNOT_REMOVE_FROM_LAST_GROUP";
      PermissionGroupErrorCode["DuplicatedInputItem"] = "DUPLICATED_INPUT_ITEM";
      PermissionGroupErrorCode["LeftNotManageablePermission"] =
        "LEFT_NOT_MANAGEABLE_PERMISSION";
      PermissionGroupErrorCode["OutOfScopePermission"] =
    ...
    (function (PostalCodeRuleInclusionTypeEnum) {
      ...
      PostalCodeRuleInclusionTypeEnum1 ||
        (PostalCodeRuleInclusionTypeEnum1 = {}),
    );
    ...
    (function (ProductErrorCode) {
      ...
      ProductErrorCode["AttributeAlreadyAssigned"] =
        "ATTRIBUTE_ALREADY_ASSIGNED";
      ProductErrorCode["AttributeCannotBeAssigned"] =
        "ATTRIBUTE_CANNOT_BE_ASSIGNED";
      ProductErrorCode["AttributeVariantsDisabled"] =
        "ATTRIBUTE_VARIANTS_DISABLED";
      ProductErrorCode["CannotManageProductWithoutVariant"] =
        "CANNOT_MANAGE_PRODUCT_WITHOUT_VARIANT";
      ...
      ProductErrorCode["ProductNotAssignedToChannel"] =
      ...
      ProductErrorCode["UnsupportedMediaProvider"] =
        "UNSUPPORTED_MEDIA_PROVIDER";
      ProductErrorCode["VariantNoDigitalContent"] =
    ...
    (function (WebhookSampleEventTypeEnum) {
      ...
      WebhookSampleEventTypeEnum["PaymentListGateways"] =
      ...
      WebhookSampleEventTypeEnum["ProductVariantCreated"] =
        "PRODUCT_VARIANT_CREATED";
      WebhookSampleEventTypeEnum["ProductVariantDeleted"] =
        "PRODUCT_VARIANT_DELETED";
      WebhookSampleEventTypeEnum["ProductVariantUpdated"] =
...
`;
    ...
    var headers = __webpack_require__(65166); // CONCATENATED MODULE: ../../pkg/saleor/src/api/client.ts
    ...
    } // CONCATENATED MODULE: ../../pkg/saleor/src/api/index.ts // CONCATENATED MODULE: ../../pkg/saleor/index.ts
  ...
  /***/ 46304: /***/ (
    ...
    var client_ = __webpack_require__(53524); // CONCATENATED MODULE: ../../pkg/prisma/index.ts
    // EXTERNAL MODULE: ../../node_modules/.pnpm/@chronark+env@0.1.2/node_modules/@chronark/env/esm/mod.js + 2 modules
    var mod = __webpack_require__(74824); // CONCATENATED MODULE: ../../pkg/webhook-context/src/setup/prisma.ts
    /**
    ...
    var saleor = __webpack_require__(50077); // CONCATENATED MODULE: ../../pkg/webhook-context/src/setup/saleor.ts
    /**
     * Create a new saleor client for the given domain
     */ const newSaleorClient = (
      ctx,
      /**
    ...
    function authorizeIntegration(integration) {
      if (!integration.enabled) {
        throw new errors /* HttpError */.oo(
          403,
          "The integration is disabled by the user",
        );
      }
