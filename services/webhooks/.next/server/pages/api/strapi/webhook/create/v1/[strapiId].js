...
/* harmony import */ var _eci_ids__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(26240);
...
const webhook1 = async ({ backgroundContext , req , res ,  })=>{
    ...
    const secret = _eci_ids__WEBPACK_IMPORTED_MODULE_4__.id.id("secretKey");
    const webhook = await ctx.prisma.incomingStrapiWebhook.create({
        data: {
            id: _eci_ids__WEBPACK_IMPORTED_MODULE_4__.id.id("publicKey"),
            strapiApp: {
                connect: {
                    id: strapiId
                }
...
var __webpack_exports__ = __webpack_require__.X(0, [938,154,172,304], () => (__webpack_exec__(35676)));
