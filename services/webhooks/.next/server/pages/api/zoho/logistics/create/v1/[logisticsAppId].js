...
/* harmony import */ var _eci_pkg_ids__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4497);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_eci_pkg_http__WEBPACK_IMPORTED_MODULE_2__, _eci_pkg_webhook_context__WEBPACK_IMPORTED_MODULE_0__, zod__WEBPACK_IMPORTED_MODULE_1__]);
([_eci_pkg_http__WEBPACK_IMPORTED_MODULE_2__, _eci_pkg_webhook_context__WEBPACK_IMPORTED_MODULE_0__, zod__WEBPACK_IMPORTED_MODULE_1__] = __webpack_async_dependencies__.then ? await __webpack_async_dependencies__ : __webpack_async_dependencies__);
...
const requestValidation = zod__WEBPACK_IMPORTED_MODULE_1__.z.object({
    query: zod__WEBPACK_IMPORTED_MODULE_1__.z.object({
        logisticsAppId: zod__WEBPACK_IMPORTED_MODULE_1__.z.string()
    })
});
const webhook1 = async ({ backgroundContext , req , res ,  })=>{
    const { query: { logisticsAppId  } ,  } = req;
    ...
    const webhook = await ctx.prisma.incomingLogisticsWebhook.create({
        data: {
            id: _eci_pkg_ids__WEBPACK_IMPORTED_MODULE_3__.id.id("publicKey"),
            logisticsApp: {
                connect: {
                    id: logisticsAppId
                }
...
var __webpack_exports__ = __webpack_require__.X(0, [914,247], () => (__webpack_exec__(177)));
