...
/* harmony import */ var _eci_ids__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(26240);
...
const webhook1 = async ({ backgroundContext , req , res ,  })=>{
    ...
    const webhook = await ctx.prisma.incomingLogisticsWebhook.create({
        data: {
            id: _eci_ids__WEBPACK_IMPORTED_MODULE_3__.id.id("publicKey"),
            logisticsApp: {
                connect: {
                    id: logisticsAppId
                }
...
var __webpack_exports__ = __webpack_require__.X(0, [938,154,172,304], () => (__webpack_exec__(90177)));
